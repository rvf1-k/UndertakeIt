...
## 1. Estructura
La interfaz de UndertakeIt se organiza mediante **tarjetas (Cards)** que flotan ligeramente, con una estética de papel moderno y ordenado.
...
El color personalizado del usuario/grupo se reserva para destacar:
...
La identidad visual de UndertakeIt busca una estética minimalista y de espacio de trabajo privado, combinando referencias de Notion y Linear.
