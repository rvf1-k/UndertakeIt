<nav id="global-nav" aria-label="Navegación principal" class="fixed bottom-0 left-0 right-0 z-40 h-16 md:h-full md:static flex flex-row md:flex-col items-center justify-between md:justify-start py-2 md:py-4 px-4 md:px-2 gap-2 bg-white border-t md:border-t-0 md:border-r border-gray-200">
    ...
    <input type="color"
        ...
        class="w-7 h-7 md:w-8 md:h-8 cursor-pointer border-none bg-transparent">
</nav>